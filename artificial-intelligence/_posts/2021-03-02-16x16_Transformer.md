...
- `from torch import einsum` 이라는 마법의 텐서 변환 모듈 사용
...
class Attention(nn.Module):
    def __init__(self, dim, heads = 8, dim_head = 64, dropout = 0.):
        ...
        # by queries : (input)1024 vectors -> 64 vectors * 8개 head 
        # by keys : 1024 vectors -> 64 vectors * 8개 head 
        # by values : 1024 vectors -> 64 vectors * 8개 head 
