...
# ***         수정 필요     ****
page_num = 73 # Git에 올라간 파일 중 가장 마지막 번호 그대로!
image_name = "pr057maskrcnn-180107092616" # _num.jpg를 제외한 이미지 이름 (pdf 이름 그대로 이다.)
link_date = "2020-04-12"  # Git repository 의 폴더 : Ex) "2020-04-12/"
